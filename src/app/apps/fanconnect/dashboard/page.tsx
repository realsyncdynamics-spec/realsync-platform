...
export default function Dashboard() {
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="bg-rose-950/30 border-b border-rose-900/30 px-5 py-3 flex items-center justify-between">
      ...
      <div className="p-8 text-center">
        ...
        <h1 className="font-black text-2xl mb-2">FanConnect</h1>
        <p className="text-gray-400 font-mono text-sm mb-6">Community Manager</p>
