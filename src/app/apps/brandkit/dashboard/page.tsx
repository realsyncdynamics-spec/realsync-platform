...
export default function Dashboard() {
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="bg-pink-950/30 border-b border-pink-900/30 px-5 py-3 flex items-center justify-between">
      ...
      <div className="p-8 text-center">
        ...
        <h1 className="font-black text-2xl mb-2">BrandKit</h1>
        <p className="text-gray-400 font-mono text-sm mb-6">KI Brand Identity</p>
