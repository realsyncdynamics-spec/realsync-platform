...
export type AppId = 'creatorseal' | 'adengine' | 'trendradar' | 'contentforge' | 'rightsguard' | 'mediavault' | 'brandkit' | 'collabhub' | 'monetizemax' | 'analyticspro' | 'schedulemaster' | 'fanconnect' | 'certificategen';
